      ...
      <div className="video-call-container">
        <div className="form-wrapper">
          <div className="brand-header">
            <h1 className="brand-title">ConnectCall</h1>
            <p className="brand-subtitle">Join millions in seamless video conversations</p>
          </div>
          ...
          <div className="signin-link">
            ...
            <Link to={'/auth2'}><span>Sign in here</span></Link>  
            </p>
          </div>
        </div>
      </div>
